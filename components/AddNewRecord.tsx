  ...
  return (
    <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-sky-50/50 to-blue-50/50 dark:from-sky-900/10 dark:to-blue-900/10 rounded-xl border border-sky-100/50 dark:border-sky-800/50'>
          ...
          <div className='space-y-1.5'>
            ...
            >
              ...
              Amount
              <span className='text-xs text-gray-400 dark:text-gray-500 ml-2 font-normal hidden sm:inline'>
                Enter amount between ₹0 and ₹50,000
              </span>
            </label>
            <div className='relative'>
        ...
        <button
          type='submit'
          className='w-full relative overflow-hidden bg-gradient-to-r from-blue-700 via-sky-600 to-cyan-500 hover:from-blue-800 hover:via-sky-700 hover:to-cyan-700 text-white px-4 py-3 sm:px-5 sm:py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl group transition-all duration-300 text-sm sm:text-base'
          disabled={isLoading}
        >
