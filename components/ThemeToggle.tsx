...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="relative w-14 h-8 bg-gradient-to-r from-blue-200/80 to-blue-200/80 dark:from-emerald-900/80 dark:to-green-900/80 backdrop-blur-sm rounded-full shadow-lg border border-emerald-200/50 dark:border-emerald-700/50">
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative w-14 h-8 bg-gradient-to-r from-blue-200/80 to-blue-200/80 dark:from-blue-900/80 dark:to-blue-900/80 hover:from-blue-300/80 hover:to-blue-300/80 dark:hover:from-blue-800/80 dark:hover:to-blue-800/80 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl border border-emerald-200/50 dark:border-emerald-700/50 transition-all duration-300 group"
